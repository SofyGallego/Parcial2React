            ...
            <div className="padre">
                <div className="card   card-body shadow-lg" >
                  <img src={ImagenProfile} alt="" className='estilo-profile' />
                    ...
                    <h4 className='texto'>{registrando ? "Si ya tienes cuenta" : "No te encuentras registrado "}<button className='btnswicth' onClick={()=>setRegistrando(!registrando)}>{registrando ? "Inicia Sesion" : "Registrate"}</button></h4>
                </div>
            </div>
        </div>
